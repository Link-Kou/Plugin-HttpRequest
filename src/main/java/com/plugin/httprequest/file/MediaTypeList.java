...
/**
 * @author lk
 * @date 2018/9/23 11:38
 */
public class MediaTypeList {

    private static HashMap<String, String> hashMaptype = new HashMap<String, String>() {
        {
            put(".001",
                    "application/x-001");
            put(".301",
    ...
    public String getType(String fileType) {
        final String s = hashMaptype.get(fileType);
        return s == null ? "multipart/form-data" : s;
    }


    public static HashMap<String, String> getHashMaptype() {
        return hashMaptype;
    }
